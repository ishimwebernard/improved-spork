...
<div class="mt-10 sm:mt-0 bg-gray-600">
  <div class="md:grid md:grid-cols-3 md:gap-6">
    <div class="md:col-span-1">
      <div class="px-4 sm:px-0">
            ...
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="flex items-start py-2">
                  ...
                  <div class="ml-3 text-sm">
                    <label for="comments" class="font-medium text-gray-700">Architecture</label>
                ...
                <div class="flex items-start py-2">
                  ...
                  <div class="ml-3 text-sm">
                    <label for="comments" class="font-medium text-gray-700">Engineering</label>
                    <p class="text-gray-500">Get notified when someones posts a comment on a posting.</p>
                  </div>
                </div>
                <div class="flex items-start py-2">
                  ...
                  <div class="ml-3 text-sm">
                    <label for="comments" class="font-medium text-gray-700">Construction</label>
                    <p class="text-gray-500">Get notified when someones posts a comment on a posting.</p>
                  </div>
                </div>
              </div>
